  ...
  if (isOwn) {
    return (
      <div className="message flex items-end justify-end gap-2">
        ...
        <div className="max-w-[82%] rounded-2xl rounded-br-none border-cup bg-primary shadow-cup-btn" style={{ padding: '10px 16px' }}>
  ...
  return (
    <div className="message flex items-end gap-2">
      ...
      <div className="flex max-w-[82%] flex-col gap-1">
        ...
        <div className="rounded-2xl rounded-tl-none border-cup bg-surface shadow-cup-btn" style={{ padding: '10px 16px' }}>
